...
description = """A bot used for ____, coded by Raven Fyre for use in the ____ Discord server."""
...
# channel_name =
# channel_name_2 =
# Plus IDs, emojis, roles, and whatever variables you want to save to continually refer back to
